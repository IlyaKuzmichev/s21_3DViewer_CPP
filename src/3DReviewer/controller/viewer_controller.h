...
class ViewerController {
 public:
  ...
  const Object& GetObject() const noexcept { return viewer_->GetObject(); }
  ...
  void SetScale(double scale) noexcept { viewer_->SetScale(scale); }
  ...
  double GetScale() const noexcept { return viewer_->GetScale(); }
