...
TEST(ParserTest, InvalidVerticeRow) {
  std::istringstream stream(
      "v 1. 1. 0.\n"
      "v -1. 1. 0.\n"
      "v -1. -1. 0.\n"
  ...
  EXPECT_THROW({ parser.Parse(stream); }, s21::Exception);
}

TEST(ParserTest, InvalidFaceRow) {
  std::istringstream stream(
      "v 1. 1. 0.\n"
      "v -1. 1. 0.\n"
      "v -1. -1. 0.\n"
