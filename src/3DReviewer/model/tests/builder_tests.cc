...
TEST(ObjectBuilderTest, SingleVertice) {
    ...
    std::vector<s21::Vertice> vertices({s21::Vertice(1., 2., 3.)});
...
TEST(ObjectBuilderTest, SeveralVertices) {
    ...
    std::vector<s21::Vertice> expected_vertices;
...
TEST(ObjectBuilderTest, SingleFace) {
    ...
    builder.
        AddVertice(s21::Vertice(0., 0., 0.)).
        AddVertice(s21::Vertice(0., 1., 0.)).
        AddVertice(s21::Vertice(0., 0., 1.)).
        AddVertice(s21::Vertice(1., 0., 0.));
