...
bool are_vertices_equal(const s21::Vertex& a, const s21::Vertex& b) {
  return are_numbers_equal(a.x, b.x) && are_numbers_equal(a.y, b.y) &&
         are_numbers_equal(a.z, b.z);
}
...
bool operator==(const s21test::TestableObject& a,
                const s21test::TestableObject& b) {
...
s21::Object* s21test::ConstructBasicTestCube(bool normalize) {
  ...
  return ConstructTestCube(vertices, normalize);
}
