...
class GLWidget : public QOpenGLWidget {
 ...
 public slots:
  void updateFrame();
  void repaintObject(const s21::ViewerController::Object *obj, s21::GLWidget::RepaintStrategy* strategy);
...
class GLWidget::RepaintStrategy {
  public:
    virtual void Repaint(const s21::ViewerController::Object* obj, std::vector<uint32_t>& faces_in_lines, QOpenGLWidget* glwidget) = 0;
...
class GLWidget::FullRepaintStrategy : public RepaintStrategy {
  public:
    ...
    void Repaint(const s21::ViewerController::Object* obj, std::vector<uint32_t>& faces_in_lines, QOpenGLWidget* glwidget) override {
      faces_in_lines.clear();
      faces_in_lines.reserve(obj->faces.size() * obj->faces[0].vertices_indices.size() * 2);
...
class GLWidget::UpdateOnlyRepaintStrategy : public RepaintStrategy {
  public:
    ...
    void Repaint(const s21::ViewerController::Object*, std::vector<uint32_t>& faces_in_lines, QOpenGLWidget* glwidget) override {
      glwidget->update();
    }
  private:
