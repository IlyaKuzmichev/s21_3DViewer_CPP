...
void s21::GLWidget::repaintObject(const s21::ViewerController::Object* obj, bool fullRepaint) {
    if (fullRepaint) {
        ...
        glBufferData(vertex_buffer_, vertices_arr_size_ * sizeof(s21::ViewerController::Vertex), &obj->vertices[0], GL_STATIC_DRAW);
        ...
        glBufferSubData(vertex_buffer_, 0, vertices_arr_size_ * sizeof(s21::ViewerController::Vertex), &obj->vertices[0]);
    }
