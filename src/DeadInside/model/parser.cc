...
void s21::ObjectParser::ParseVertice(std::string& line, s21::ObjectBuilder& builder) const {
    double x, y, z;
...
void s21::ObjectParser::ParseFace(std::string& line, s21::ObjectBuilder& builder) const {
    std::istringstream stream(line);
